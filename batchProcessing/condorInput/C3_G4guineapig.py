...
def run():
  ...
  geant4.setupROOTOutput('ROOTOutput', 'C3SiD_1')
  ...
  fname = './pairs_230385_0.dat' # os.environ['DD4hepINSTALL'] + '/examples/CLICSiD/scripts/pairs_rndm_seed_100805.dat'
  ...
  rng = sid.setupRandom('R1', seed=1, type='MTwistEngine')
