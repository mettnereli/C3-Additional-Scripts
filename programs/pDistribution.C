...
void pDistribution() {
TH1D *p_0_all, *p_0_electrons, *p_0_positrons, *p_0_photons;
p_0_all = new TH1D("p_0_all", "p_0_all",100,0, 5);
p_0_electrons = new TH1D("p_0_electrons","p_0_electrons",100,0,20);
p_0_positrons = new TH1D("p_0_positrons","p_0_positrons",100,0,20);
p_0_photons = new TH1D("p_0_photons","p_0_photons",100,0,5);
TH1D *pT_0_all, *pT_0_electrons, *pT_0_positrons, *pT_0_photons;
pT_0_all = new TH1D("pT_0_all", "pT_0_all",100,0, 5);
pT_0_electrons = new TH1D("pT_0_electrons","pT_0_electrons",100,0,20);
pT_0_positrons = new TH1D("pT_0_positrons","pT_0_positrons",100,0,20);
pT_0_photons = new TH1D("pT_0_photons","pT_0_photons",100,0,5);
...
TTreeFormula Rho("Rho", "SiVertexBarrelHits.momentum.Rho()",tree);
 for(int i=0; i<nentries; i++)
 {
	...
	if (x == 0 && y == 0 && z == 0) {
	 if (pdg==11) { p_0_electrons->Fill(p); pT_0_electrons->Fill(pT); }
	 if (pdg==-11) { p_0_positrons->Fill(p); pT_0_positrons->Fill(pT); }
	 if (pdg==22) { p_0_photons->Fill(p); pT_0_photons->Fill(pT); }
	 p_0_all->Fill(p);
	 pT_0_all->Fill(pT);
	}
	 }	
