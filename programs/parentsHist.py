...
if __name__ == '__main__':
	 ...
	 #ps parent momenta histograms
         h7 = hist.Hist(hist.axis.Regular(bins=80, start=-25000, stop=25000, name="psParent"))
         h8 = hist.Hist(hist.axis.Regular(bins=80, start=-25000, stop=25000, name="psXParent"))
         h9 = hist.Hist(hist.axis.Regular(bins=80, start=-25000, stop=25000, name="psYParent"))
         h10 = hist.Hist(hist.axis.Regular(bins=80, start=-25000, stop=25000, name="psZParent"))
         h11 = hist.Hist(hist.axis.Regular(bins=80, start=-25000, stop=25000, name="psHit"))
         h12 = hist.Hist(hist.axis.Regular(bins=80, start=-25000, stop=25000, name="psXHit"))
         h13 = hist.Hist(hist.axis.Regular(bins=80, start=-25000, stop=25000, name="psYHit"))
